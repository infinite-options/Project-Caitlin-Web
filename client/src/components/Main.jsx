...
giveAcessToTA = () => {
  ...
  db.collection("users").doc(this.state.currentUserId).get()
  .then((doc) => {
    db.collection("trusted_advisor").doc(this.state.currentAdvisorCandidateId).get()
    .then(
      ( snapshot ) => {
        let found = false
        ...
        if (!found) {
          db.collection("trusted_advisor").doc(this.state.currentAdvisorCandidateId)
          .update({
        ...
        {/* <Col>
          ...
          { this.state.showAllowTAmodel === false ? (
            ...
            { this.state.showAllowTAmodel === true ? (
              ...
              variant="outline-primary"
              style={{ marginTop: "10px" }}
              title={ this.state.currentAdvisorCandidateName || "Choose the advisor" }
              >
