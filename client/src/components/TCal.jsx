...
export default class TylersCalendarv1 extends React.Component {
        ...
        if (i >= startDate && i <= endDate) {
          res.push(
            <div key={"event" + j}>
              ...
              >
                {this.props.originalEvents[j].summary}
              </button>
              <br />
            </div>
          );
  ...
  render() {
    ...
    var sameDate =
      this.props.dateObject.format("DD/MM/YYYY") ===
      this.props.dateContext.format("DD/MM/YYYY");
      ...
      daysInMonth.push(
        <td key={d} onClick={this.onDayClick.bind(this, d)}>
          ...
          >
            ...
            <div
              className={
                sameDate && d === parseInt(this.currentDay(), 10)
                  ? "numberCircle"
                  : ""
              }
            >
    ...
    return (
      <div>
        <table
          className="table"
          style={{ height: "450px", tableLayout: "fixed", width: "910px" }}
        >
          <thead>
            <tr>{weekdays}</tr>
          </thead>
